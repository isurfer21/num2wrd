...
void N2W::print(int num) {
  ...
  case 6:
    ...
    break;
  case 7:
    strcat(num_str, "SEVEN ");
    break;
  case 8:
    strcat(num_str, "EIGHT ");
    break;
  case 9:
    strcat(num_str, "NINE ");
    break;
...
void N2W::print_pair(int num) {
  ...
  case 1:
    switch (stack[top]) {
    case 1:
      strcat(num_str, "ELEVEN ");
      break;
    case 2:
      strcat(num_str, "TWELVE ");
      break;
    case 3:
      strcat(num_str, "THIRTEEN ");
      break;
    case 4:
      strcat(num_str, "FOURTEEN ");
      break;
    case 5:
      strcat(num_str, "FIFTEEN ");
      break;
    case 6:
      strcat(num_str, "SIXTEEN ");
      break;
    case 7:
      strcat(num_str, "SEVENTEEN ");
      break;
    case 8:
      strcat(num_str, "EIGHTEEN ");
      break;
    case 9:
      strcat(num_str, "NINETEEN ");
      break;
    case 0:
      strcat(num_str, "TEN ");
      nested_flag = 0;
    ...
    break;
  case 2:
    strcat(num_str, "TWENTY ");
    break;
  case 3:
    strcat(num_str, "THIRTY ");
    break;
  case 4:
    strcat(num_str, "FORTY ");
    break;
  case 5:
    strcat(num_str, "FIFTY ");
    break;
  case 6:
    strcat(num_str, "SIXTY ");
    break;
  case 7:
    strcat(num_str, "SEVENTY ");
    break;
  case 8:
    strcat(num_str, "EIGHTY ");
    break;
  case 9:
    strcat(num_str, "NINETY ");
    break;
  }
}
